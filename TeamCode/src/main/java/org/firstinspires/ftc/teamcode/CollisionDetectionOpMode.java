...
import org.firstinspires.ftc.teamcode.drivesys.FourMotorDrive;
...
public class CollisionDetectionOpMode extends LinearOpMode {
    ...
    double frictionCoefficientL = 1.0;
    double frictionCoefficientR = 1.0;

    FourMotorDrive fourMotorDrive;
    ...
    public void runOpMode() throws InterruptedException{
        ...
        fourMotorDrive = new FourMotorDrive(fMotorL,fMotorR,rMotorL,rMotorR,maxSpeed,minSpeed,frictionCoefficientR,frictionCoefficientL,wheel);
